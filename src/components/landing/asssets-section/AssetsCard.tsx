                ...
                <Card className="w-64 p-6">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="text-text-secondary text-sm">
                            List surplus kWh from your photovoltaic installation. 
                            Any rooftop system from 2 kW and above is eligible.
                        </p>
                ...
                <Card className="w-64 p-6">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                                ...
                                <h3 className="text-label-lg text-foreground">EV Vehicle-to-Grid</h3>

                        </div>

                        <p className="text-text-secondary text-sm">
                            Turn your electric vehicle into a household grid asset. 
                            Export from your EV's battery when you're parked at home.
                        </p>
